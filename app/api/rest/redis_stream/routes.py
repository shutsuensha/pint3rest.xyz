...
router = APIRouter(prefix="/redis-stream", tags=["redis-stream"], include_in_schema=False)
...
async def add_message_to_stream(
    ...
    return {"message": f"Сообщение добавлено в поток '{stream_name}' с ID {message_id}."}
